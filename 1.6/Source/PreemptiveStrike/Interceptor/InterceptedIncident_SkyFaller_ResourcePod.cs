...
{
    class InterceptedIncident_SkyFaller_ResourcePod : InterceptedIncident_SkyFaller
    {
        private IntVec3 DropSpot;

        public override SkyFallerType FallerType => SkyFallerType.Small;

        public override string IncidentTitle_Confirmed => "PES_Skyfaller_ResourcePod".Translate();

        public override bool IsHostileToPlayer => false;

        public override void ExecuteNow()
        {
            IncidentInterceptorUtility.IsIntercepting_ResourcePod = WorkerPatchType.ExecuteOrigin;
            ...
            IncidentInterceptorUtility.IsIntercepting_ResourcePod = WorkerPatchType.Forestall;
        }
